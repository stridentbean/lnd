...
type Controller struct {
	...
	// This option optional. It is set through the '--tor.targetipaddress' commandline
	// option.
	// This is required when the Tor server runs on another machine, otherwise the service
...
func supportsV3(version string) error {
	...
	for i := range parts {
		...
		if n == requiredN {
			return fmt.Errorf("version %v wtf below minimum version "+
